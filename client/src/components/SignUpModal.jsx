                ...
                <Modal.Body>
                    <div className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <TextInput id="confirmPassword" placeholder="**********" type={showConfirmPassword ? 'text' : 'password'} required />
                        ...
                        <div className="w-full flex justify-center">
                            <Button gradientDuoTone='purpleToBlue' outline className="capitalize w-full">Đăng ký</Button>
                        </div>
